    ...
    public static void main(String[] args) {
        ...
        if (userIn.equals("speed")){
            ...
            double userSpeed = Double.parseDouble(userSpeedString);
                ...
                } else if (mphVS.equals("metres per second") || (mphVS.equals("meters per second") || (mphVS.equals("m/s") || (mphVS.equals("mps"))))){
                ...
                } else if (mphVS.equals("feet per second") || (mphVS.equals("foot per second") || (mphVS.equals("f/s") || (mphVS.equals("fps"))))){
                ...
                } else if (speedSelect.contains("kph") || (speedSelect.contains("kilometres per hour") || (speedSelect.contains("kilometers per hour")))){
                ...
                } else if (kphVS.equals("metres per second") || (kphVS.equals("m/s") || (kphVS.equals("mps") || (kphVS.equals("meters per second"))))){
                ...
                } else if (kphVS.equals("feet per second") || (kphVS.equals("foot per second") || (kphVS.equals("f/s") || (kphVS.equals("fps"))))){
                ...
                } else if (speedSelect.contains("mps") || (speedSelect.contains("meters per second") || (speedSelect.contains("metres per second")))){
                ...
                } else if (mpsVS.equals("feet per second") || (mpsVS.equals("foot per second") || (mpsVS.equals("f/s") || (mpsVS.equals("fps"))))){
                ...
                } else if (fpsVS.equals("metres per second") || (fpsVS.equals("meters per second") || (fpsVS.equals("m/s") || (fpsVS.equals("mps"))))){
                ...
                } else if (ktsVS.equals("metres per second") || (ktsVS.equals("meters per second") || (ktsVS.equals("m/s") || (ktsVS.equals("mps"))))){
